...
export class ReverbTreeProvider
  implements vscode.TreeDataProvider<RouteItem | PathItem> {
  // Construct a new ReverbDependenciesProvider, pass workspaceRoot up to TreeDataProvider constructor
  constructor(
    private workspaceRoot: string,
    workspaceObj: WorkspaceObj | undefined,
  ) {
  ...
  private generateRouteItems(
    routeData:
      | EndPointMethods
      | { [endpoint: string]: EndPointMethods }
      | undefined,
  ): RouteItem[] {
